classdef SynchrophasorAppApp < handle
    %
    % Usage:
    %     app.SynchrophasorAppApp
    ...
    properties (Constant)
        AppPathBase = {'/SynchrophasorApp'};
        AppClass = 'SynchrophasorAppApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = SynchrophasorAppApp()
        ...
        function startApp(obj)
            ...
            mlock;
            SynchrophasorAppApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'SynchrophasorApp')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong SynchrophasorApp
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'SynchrophasorApp').getString, ...
            ...
            if nargout(@SynchrophasorApp) == 0
                eval('SynchrophasorApp');
            else
                obj.AppHandle = eval('SynchrophasorApp');
            end
